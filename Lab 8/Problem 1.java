...
public class WindowsExplorer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        explorer(tree,commands);
    }

    public static void explorer(SLLTree<String> tree, String [] commands){
            ...
            switch(instruction){
                ...
                case "DELETE":{
                    ...
                    while (tmp.sibling != null){
                        if (tmp.sibling.element.equals(node)){
                ...
                case "PATH": {
                    ...
                    SLLNode<String> currentNode = curr;
                
                    while (currentNode != null) {
                        dir.push(currentNode.getElement());
                        currentNode = currentNode.parent;
                    }
                
                    StringBuilder pathString = new StringBuilder();
                    while (!dir.isEmpty()) {
                        pathString.append(dir.pop());
                        if (!dir.isEmpty()) {
                            pathString.append("\\");
                        }
                    }
