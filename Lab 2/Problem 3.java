 ...
 */
 ...
 public class MysticalCardGame {
     ...
     public static void startDuel(SLL<Card> firstSorcererCards, SLL<Card> secondSorcererCards) {
         ...
         SLLNode<Card> currentCard = firstSorcererCards.getFirst().succ;
         while (currentCard != null) {
             if (currentCard.element.significance() > bestCard.element.significance()) {
                 bestCard = currentCard;
             }
             currentCard = currentCard.succ;
         }
         int lenHalf=secondSorcererCards.size()/2;
         SLLNode<Card> middleNode = secondSorcererCards.getFirst();
         for (int i=0; i<lenHalf; i++){
             middleNode=middleNode.succ;
         }
 
         secondSorcererCards.insertBefore(bestCard.element, middleNode);
