...
public class Preveduvac {
    public static void main (String[] args) throws IOException {
        ...
        OBHT<String, String> hashTable = new OBHT<>(150);

        for (int i=0; i<n; i++){
            String input = bufferedReader.readLine();
            String [] splitInput = input.split(" ");
            hashTable.insert(splitInput[1],splitInput[0]);
        }
        ...
        for(;;){
            ...
            int searchHash = hashTable.search(line);
            if (searchHash!=-1){
                System.out.println(hashTable.getBucket(searchHash).value);
